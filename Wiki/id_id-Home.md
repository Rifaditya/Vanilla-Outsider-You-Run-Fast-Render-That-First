# 🚀 Kamu Lari Cepat, Render Itu Dulu (You Run Fast, Render That First)
...
You Run Fast, Render That First adalah mod optimasi Fabric performa tinggi yang dirancang untuk menghilangkan pop-in chunk dan dinding hampa saat bepergian dengan kecepatan tinggi.

---

## ⚡ Kamu Lari Cepat, Render Itu Dulu (You Run Fast, Render That First) — 핵심 기능 / 主要特性
...
- **GameRules Dinamis & Perintah**: Dukungan penuh GameRules yourunfast:* dan perintah Brigadier /yourunfast.
