# 💻 Configuration développeur et compilation depuis les sources
...
Le projet utilise Gradle avec Fabric Loom pour Java 25+. Chaque version est isolée dans son sous-projet.

### 1. Prérequis
- **JDK** : Java 25 ou supérieur.
- **Git** : 2.40+
- **IDE** : IntelliJ IDEA 2024.3+ ou Eclipse.
...
Pour compiler et tester une version spécifique :
