# 🚀 Minecraft 26.1 (26.1.2) — You Run Fast, Render That First
...
Welcome to the sovereign technical documentation for **Vanilla Outsider: You Run Fast, Render That First** on **Minecraft 26.1.2**.
...
| **Architecture** | [[Architecture & Mixins|Architecture-and-Mixins]] | Detailed Mixin inspection (`CompileTaskDynamicQueueMixin`), FastUtil data structures, memory model |
